...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PF1     ------> I2C2_SCL
    */
    GPIO_InitStruct.Pin = ALT_SDA_Pin|ALT_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    */
    ...
    /* I2C4 DMA Init */
    /* I2C4_RX Init */
    hdma_i2c4_rx.Instance = DMA1_Stream1;
    hdma_i2c4_rx.Init.Channel = DMA_CHANNEL_8;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  else if(hi2c->Instance==I2C2)
  {
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(ALT_SDA_GPIO_Port, ALT_SDA_Pin);

    HAL_GPIO_DeInit(ALT_SCL_GPIO_Port, ALT_SCL_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PD5     ------> USART2_TX
    */
    GPIO_InitStruct.Pin = RADIO_Telemetry_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(RADIO_Telemetry_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PG9     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = WLSER_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_USART6;
    HAL_GPIO_Init(WLSER_TX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = WLSER_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_USART6;
    HAL_GPIO_Init(WLSER_RX_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PD5     ------> USART2_TX
    */
    HAL_GPIO_DeInit(RADIO_Telemetry_GPIO_Port, RADIO_Telemetry_Pin);
  ...
  else if(huart->Instance==USART6)
  {
    ...
    PG9     ------> USART6_RX
    */
    HAL_GPIO_DeInit(WLSER_TX_GPIO_Port, WLSER_TX_Pin);

    HAL_GPIO_DeInit(WLSER_RX_GPIO_Port, WLSER_RX_Pin);
